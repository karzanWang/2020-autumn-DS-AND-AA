...
class MyIterator<T> {
    ...
    /**
     * get the first element, to iterate from the first to the last
     *
    ...
    /**
     * get the last element, to iterate from the last to the first
     *
    ...
    /**
     * todo iterate from first to last whether to end or not
     *
     * @return if ends 从头到尾遍历
     */
    ...
    /**
     * todo iterate from last to first whether to end or not 从尾到头遍历
     *
     * @return if ends
     */
    ...
    /**
     * todo need to parse {@link NullPointerException}, or throw it from first to
     * last
     *
     * @return next value
     */
    ...
    /**
     * todo need to parse {@link NullPointerException}, or throw it from the last to
     * the first
     *
     * @return prev value
     */
...
public class MyLinkedList<T> {
    ...
    /**
     * todo insert value to the start of the list i.e., addFirst(1) to List 3 - 7 -
     * 2 and get 1 - 3 - 7 - 2
     *
     * @param item value
     */
    public void addFirst(T item) {
        if (size == 0) {
            ...
            this.head = new MyNode<>(item, t, null);
            t.prev = this.head;
        }
        size++;
    ...
    /**
     * todo remove value at the start of the list and return it
     *
