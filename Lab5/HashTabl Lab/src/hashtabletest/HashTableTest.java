...
public class HashTableTest {
    ...
    public  void testIntegerHash(){
        HashTable hashTable1 = new HashTable();
         ArrayList<HashTableElement> elements1 =new ArrayList<>();
        System.out.println(HashTable.CAPACITY);
        for (int i = 0; i <  10*HashTable.CAPACITY; i++) {
            Object key = new Integer(getUniqueRandom());
            Object data = new Integer(getRandom());
            elements1.add(new HashTableElement(key, data));
        }

        for (HashTableElement element : elements1) {
            hashTable1.insert(element);
        }
        System.out.println(hashTable1.getChainLengths());
        System.out.println(hashTable1.meanChainLength());
        System.out.println(hashTable1.standardDeviation());
    }
    /**
